...
Route::group(['middleware' => 'jwt.auth'], function () {
    ...
    Route::get('auditoria/{auditoriaId}', 'API\AuditoriaController@GetClaveAuditoria');
    ...
    Route::get('procedimiento/nivel-dos/ramo-fondo/{refRamoFondo}/ejercicio/{ejercicio}/procedimiento/{refProcedimiento}', 
                'API\CatProcedimientoController@CatProcedimientoNivel2');
    ...
    Route::get('resultado/{idResultado}', 'API\ResultadoXAuditoriaController@GetResultadoXId');
